...
<div class="row">
	...
	<div class="col-md-3">
		<div class="mb-3">
			...
			<input name="cor" type="text" class="form-control" placeholder="#483D8B" value="<?php echo $cor_sistema ?>">
		</div>
	</div>
...
<div class="row">
	...
	<div class="col-md-2 col-4">
		<div><img id="target-logo" src="../img/logo-giga-white.gif" width="110px" style="margin-top: 15px"></div>
	</div>
	...
	<div class="col-md-2 col-4">
		<div><img id="target-icone" src="../img/icone.gif" width="50px" style="margin-top: 25px"></div>
	</div>
